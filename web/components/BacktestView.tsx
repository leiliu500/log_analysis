...
/**
 * Validation Backtest view — trigger the hand-labelled gold-set corpus through the
 * real validation engine and review the false-positive / false-negative /
 * hallucination results. Manual only (the same corpus is also a CI gate).
 */
export function BacktestView() {
  ...
  // Manual only — the backtest runs when the user clicks "Run backtest".
